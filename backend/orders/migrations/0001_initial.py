    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_location', models.ForeignKey(blank=True, db_column='from_location_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders_from', to='locations.location')),
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='jobs.job')),
                ('to_location', models.ForeignKey(blank=True, db_column='to_location_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders_to', to='locations.location')),
