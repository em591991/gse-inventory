    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(db_column='location_id', on_delete=django.db.models.deletion.PROTECT, related_name='vehicles', to='locations.location')),
            ],
            options={
                'db_table': 'vehicles',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, db_column='location_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vehicle_assignments', to='locations.location')),
